...
const StaffProfile = () => {
  ...
  const confirmAdminRequest = () => {
    Alert.alert(
      "Confirm Request",
      "Are you sure you want to request admin access? You will lose access to your staff account once request is sent.",
      [
        {
          text: "Cancel",
          style: "cancel"
  ...
  const requestAdminAccess = async () => {
    try {
      ...
      Alert.alert('Admin Access Requested', 'Your request is pending approval by an admin.');
    } catch (error) {
    ...
    <View style={styles.profileView}>
          ...
          <Pressable
                    ...
                    onPress={confirmAdminRequest}>
                        <Text style={styles.text}>Request Admin Access</Text>
          </Pressable>
        </View>
  )
}
